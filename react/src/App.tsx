...
import { Stake, ChooseBond, Bond, TreasuryDashboard, Wrap } from "./views";
...
// 🛰 providers
if (DEBUG) {
  console.log("📡 Connecting to Mainnet Findora");
}
// 🔭 block explorer URL
...
function App() {
  ...
  useEffect(() => {
    ...
    if (shouldTriggerSafetyCheck()) {
      dispatch(info("Safety Check: Always verify you're on atherton.finance!"));
    }
  }, []);
