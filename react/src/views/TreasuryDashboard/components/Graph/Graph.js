...
export const ProtocolOwnedLiquidityGraph = () => {
  ...
  return (
    <Chart
      ...
      headerText="Protocol Owned Liquidity ATHER-DAI"
      expandedGraphStrokeColor={theme.palette.graphStrokeColor}
...
export const ATHERStakedGraph = () => {
  ...
  const staked =
    ...
    data
      .map(metric => ({
        staked: (metric.sOhmCirculatingSupply / metric.atherCirculatingSupply) * 100,
