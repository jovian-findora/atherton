...
export const tooltipInfoMessages = {
  tvl: "Total Value Deposited, is the dollar amount of all ATHER staked in the protocol. This metric is often used as growth or health indicator in DeFi projects.",
  mvt: "Market Value of Treasury Assets, is the sum of the value (in dollars) of all assets held by the treasury.",
  rfv: "Risk Free Value, is the amount of funds the treasury guarantees to use for backing ATHER.",
  ...
  holder: "Holders, represents the total number of Atheries (sATHER holders)",
  staked: "ATHER Staked, is the ratio of sATHER to ATHER (staked vs unstaked)",
  ...
  runway: "Runway, is the number of days sATHER emissions can be sustained at a given rate. Lower APY = longer runway",
};
