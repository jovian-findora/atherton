...
export default function ExternalStakePool() {
  ...
  const atherLusdReserveBalance = useSelector(state => {
    return state.account && state.account.bonds?.ather_lusd_lp?.balance;
  });
  ...
  return (
    <Zoom in={true}>
      <Paper className={`ather-card secondary ${isSmallScreen && "mobile"}`}>
          ...
          {!isSmallScreen ? (
            <TableContainer className="stake-table">
              <Table>
                ...
                <TableBody>
                  <TableRow>
                    <TableCell>
                      <Box className="ather-pairs">
                        <BondLogo bond={{ bondIconSvg: AtherLusdImg, isLP: true }}></BondLogo>
                        <Typography>ATHER-LUSD</Typography>
                      </Box>
                    </TableCell>
                    <TableCell align="left">
                      {isLusdLoading ? (
                    ...
                    <TableCell align="left">
                      {isLusdLoading ? <Skeleton width="80px" /> : (trim(atherLusdReserveBalance, 2) || 0) + " SLP"}
                    </TableCell>
            ...
            <div className="stake-pool">
              <div className={`pool-card-top-row ${isMobileScreen && "small"}`}>
                <Box className="ather-pairs">
                  <BondLogo bond={{ bondIconSvg: AtherLusdImg, isLP: true }}></BondLogo>
                  <Typography gutterBottom={false}>ATHER-LUSD</Typography>
                </Box>
              </div>
