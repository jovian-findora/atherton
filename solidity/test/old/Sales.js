...
//         it('should burn left ATHER from lastEpoch when indicator = 1 i.e sales receives DAI, returns totalOlyToken as 0', async () => {
//             const indicatorA = 0;
//             const indicatorB = 1;
//             const amountToSell = '1000000000000000000';
//             await olytoken.mint(sale.address, amountToSell);
...
//         it('should transfer left DAI from lastEpoch to treasury when indicator = 0 i.e sales receives ATHER, returns totalDAIToken as 0', async () => {
//             const indicatorA = 0;
//             const indicatorB = 1;
//             const amountToSell = '1000000000000000000';
...
//         it(`Should swap user DAI for ATHER from sales contract, and send user DAI to treasury`, async () => {
//             const indicatorA = 0;
//             await sale.connect(treasury).updateNext8Hrs(amountToSell,indicatorA);
...
//             await sale.buy('ather',amountToSell);
...
//         it(`Should swap user ATHER for DAI from sales contract, and burn user ATHER`, async () => {
//             const indicatorA = 1;
//             await sale.connect(treasury).updateNext8Hrs(amountToSell,indicatorA);
//             const ownerOlyBalBeforeBuy = BigInt(await olytoken.balanceOf(owner.address)).toString();
//             const ownerDAIBalBeforeBuy = BigInt(await dai.balanceOf(owner.address)).toString();
...
//         it(`Should swap user ATHER for DAI from uniswap, and burn user ATHER`, async () => {
//             const ownerOlyBalBeforeBuy = BigInt(await olytoken.balanceOf(owner.address)).toString();
//             const ownerDAIBalBeforeBuy = BigInt(await dai.balanceOf(owner.address)).toString();
//             await sale.buy('dai',amountToSell);
//             const ownerOlyBalAfterBuy = BigInt(await olytoken.balanceOf(owner.address)).toString();
