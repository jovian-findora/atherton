...
contract sAtherton is ERC20Permit, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 5000000 * 10**18; // 5 million initial supply
    ...
    /**
        @notice increases sATHER supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sATHER
